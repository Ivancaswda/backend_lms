...
const StudentsEnrolled = () => {
    ...
    return !enrolledStudents ? <Loading/> :  (
            ...
            <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden
             rounded-md bg-white border border-gray-500/20'>
                <table className='table-fixed md:table-auto w-full overflow-hidden pb-4'>
                    <thead className='text-left text-gray-900 border-b border-gray-500/20 text-sm'>
                        <tr>
                            <th className='px-4 py-3 font-semibold text-center hidden sm:table-cell'>#</th>
                            <th className='px-4 py-3 font-semibold'>Имя студента</th>
                            <th className='px-4 py-3 font-semibold'>Название курса</th>
                            <th className='px-4 py-3 font-semibold hidden sm:table-cell'>Дата</th>
                        </tr>
                    </thead>
